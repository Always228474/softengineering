...
def predict_bike_availability(station_id, time_str):
    ...
    hour = date_time.hour
    day_of_week = date_time.weekday()  # Get the day of the week (0=Monday, 6=Sunday)
    ...
    expected_columns = encoder.get_feature_names_out(['station_id']).tolist() + ['temp', 'humidity', 'hour', 'day']
...
# Example usage
time_str = "09:00"
station_id = "station_id_29"  # Define the station_id here
